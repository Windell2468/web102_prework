...
We need your help to fund ${unfundedCount === 1 ? 'this awesome game' : 'these awesome games'}!`;
...
const [ topFirstAwesomeGames, secondAwesomeFundedGames, ...restOfAwesomeGames] = sortedGames

// create a new element to hold the name of the top pledge game, then append it to the correct element
const topAwesomeGames = document.createElement('h4');
topAwesomeGames.textContent = topFirstAwesomeGames.name;
firstGameContainer.appendChild(topAwesomeGames);

// do the same for the runner up item
const secondBestFundedGames = document.createElement('h4');
secondBestFundedGames.textContent = secondAwesomeFundedGames.name;
secondGameContainer.appendChild(secondBestFundedGames);